        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-11/12 max-w-md p-6">
          ...
          <form onSubmit={handleSubmit} class="space-y-4">
            ...
            <div class="flex space-x-2 mt-4">
              <button
                type="submit"
                class="flex-1 py-2 px-4 bg-purple-600 text-white rounded font-semibold hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
              >
                حفظ
              </button>
              <button
                type="button"
                class="flex-1 py-2 px-4 bg-red-500 text-white rounded font-semibold hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 cursor-pointer"

    ...
    <Show when={showInstructions()}>
      <div class="mb-6 p-4 bg-gray-100 rounded-lg shadow-inner overflow-y-auto h-full">
        ...
        <ul class="list-disc list-inside text-gray-800 space-y-2">
          ...
          <li>أثناء التسجيل، يمكنك إيقافه بالضغط على زر "إيقاف التسجيل".</li>
          <li>عند استخدام التسجيل الصوتي، يتم تشغيل الرد الصوتي تلقائيًا.</li>
          <li>
          ...
          <li>
            يمكنك تخصيص تجربتك من خلال قسم الإعدادات لتغيير حجم الخط وألوان
            الواجهة وسرعة الصوت.
          </li>
        </ul>
        <button

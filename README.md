...
3. **التفاعل مع الذكاء الاصطناعي:**
   ...
   - عند استخدام **التسجيل الصوتي**:
     ...
     - **يتم تشغيل الرد الصوتي تلقائيًا عند استخدام التسجيل الصوتي، بغض النظر عن حالة خيار "تشغيل الصوت عند الرد".**
...
4. **التحكم في الصوت أثناء الردود:**
   ...
   - يقدم التطبيق خيارًا للمستخدم **لتفعيل أو تعطيل الصوت** أثناء الردود عند استخدام الإدخال النصي.
   - **عند استخدام الإدخال الصوتي، يتم تشغيل الرد الصوتي تلقائيًا.**
...
6. **الاستماع للرد والبدء بتسجيل جديد تلقائيًا:**
   ...
   - بعد الحصول على الرد النصي من الذكاء الاصطناعي، إذا كان الصوت **مفعلاً** أو تم استخدام التسجيل الصوتي:
     - يقوم التطبيق تلقائيًا بتحويل الرد إلى كلام وتشغيله للمستخدم.
     - **يمكن للمستخدم إيقاف وتشغيل الصوت أثناء الرد باستخدام الزر المخصص.**
     - **بعد انتهاء تشغيل الصوت، يبدأ التطبيق تلقائيًا بتسجيل صوت المستخدم للاستفسار التالي بغض النظر عن كيفية الإدخال السابق.**
     - **لا يحتاج المستخدم للضغط على أي زر لبدء التسجيل؛ يتم ذلك تلقائيًا.**
   - إذا كان الصوت **معطلاً** وتم استخدام الإدخال النصي:
